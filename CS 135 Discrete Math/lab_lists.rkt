...
;; 2 PTS
(define (yoda words)
  (cons (car (reverse words)) (list (car words) (cadr words)))
  )
...
;; 2 PTS
(define (rotate c)
  (list (list (car c) (car (reverse c))) (list (car (reverse c)) (* -1 (car c))) (list (* -1 (car c)) (* -1 (car (reverse c)))) (list (* -1 (car (reverse c))) (car c)))
)
