...
(define (waterjug-helper fA fB cA cB g)
  (cond [(= fB g) (cons (list fA fB) '())]
        [(= fB cB) (cons (list fA fB) (waterjug-helper fA 0 cA cB g))]
        [(= 0 fA) (cons (list fA fB) (waterjug-helper cA fB cA cB g))]
        [(> (+ fA fB) cB) (cons (list fA fB) (waterjug-helper (- fA (- cB fB)) cB cA cB g))]
        [(<= (+ fA fB) cB) (cons (list fA fB) (waterjug-helper 0 (+ fA fB) cA cB g))]
...
(define (factorize-helper n a)
  (cond [(= n 1) '()]
        [(= 0 (modulo n a)) (cons a (factorize-helper (/ n a) a))]
        [else (factorize-helper n (+ a 1))]
        )
  )
